...
public class miasto {
   ...
   public boolean tattocheck = false;
    ...
    public void wybrzerze() throws InterruptedException {
        int wyborwybrzerze;
        print.PrintTxt("Po dotarciu na wybrzeże Słońce odbijające się od piasku lekko razi twoje oczy" +
                ...
                "1 - tak\n" +
                "2 - nie \n",225);
        wyborwybrzerze= scanner.nextInt();
        while (1==1){
            if (wyborwybrzerze==1){
                print.PrintTxt("Zauważasz też że cała ziemia na wyspie jest czarna i ma metaliczny połysk, lecz na wyspie znajduje się roślinność.",225);
                Thread.sleep(1500);
                print.PrintTxt("Po chwili przyglądania się wyspie dostrzegasz że na jej wybrzeżu znajduje się port.\n" +
                        "Zaś u portu stoi jakaś łódź. Na jej boku znajdują się znaki, które wyglądają jak litery K, S i U z twoich stron.\n" +
                        "Zaczynasz się zastanawiać czy ta łódź wyruszyła z twojej ojczyzny",225);
                Thread.sleep(2000);
                print.PrintTxt("Po chwili rozmyślania udajesz się z powrotem na plac miejski\n",225);
                break;
            }
            else if (wyborwybrzerze==2) {
                System.out.println("Ignorując wyspę zawracasz i wracasz na plac miejski");
                break;}
            else {
                System.out.println("nie poprawna opcja. proszę wybrać poprawną opcję");
    ...
    public void  Stragany() throws InterruptedException {
        print.PrintTxt("Przechadzasz się krętymi ulicami i podziwiasz róźnorodność oferowanych produktów.\n" +
        ...
        while (1==1){
            if (wybor ==1){
                ...
                print.PrintTxt("Udajesz się z powrotem na plac miejski",225);
                break;
    ...
    public void Karczma(Player gracz) throws InterruptedException{
        ...
        if (CzyBylWKarczmie==false){
            print.PrintTxt("Po wejściu do karczmy pierwsza rzeczą która rzucza ci się w oczy jest\n" +
                    ...
                    "masz pojęcia jak wygląda jego twarz.",225);
            Thread.sleep(7500);
            System.out.println("Co zamierzasz zrobić?\n" +
                    ...
                    "4 - wyjść z karczmy");
            wyborkarczma=scanner.nextInt();
            while (1==1){
                if (wyborkarczma==1){
                    print.PrintTxt("Barman:\nCo dla ciebie podróżniku?\n" +
                    ...
                    if (wybor1==3){print.PrintTxt("Barman:\nTo będzie 6 srebrnych monet za kieliszek.\n\n" +
                        ...
                        if (wybor2==1){
                            print.PrintTxt("Pytasz barmana czy możesz kupić teraz i zapłacić później",225);
                            for (int i =0; i<7;i++){
                                System.out.print(". ");
                                Thread.sleep(500);
                            }
                            ...
                            if (los(10)==7){
                                if (wybor1 == 1) {
                                print.PrintTxt("Barman po chwili namysłu daje ci odpowiedź\n" +
                                        ...
                                        "odchodzisz od baru.",225);
                                Thread.sleep(5000);
                                }
                                if (wybor1==2){ print.PrintTxt("Barman po chwili namysłu daje ci odpowiedź\n" +
                                        "Barman:\n Oczywiście, aczkolwiek po wyjściu z tej knajpy będziesz miał tydzień\n" +
                                        "aby zapłacić cały dzisiejszy rachunek\n\n" +
                                        ...
                                        " Następnie wstajesz i  odchodzisz od baru.",200);
                                Thread.sleep(5000);
                                }
                                if (wybor1 == 3) { print.PrintTxt("Barman po chwili namysłu daje ci odpowiedź\n" +
                                        "Barman:\n Oczywiście, aczkolwiek po wyjściu z tej knajpy będziesz miał tydzień\n" +
                                        "aby zapłacić cały dzisiejszy rachunek\n\n" +
                                ...
                                print.PrintTxt("Barman po chwili namysłu daje ci odpowiedź\n" +
                                        ...
                                        "jak złość się w tobie buduje",225);

                            }

                        }
                else if (wyborkarczma==2){
                    print.PrintTxt("Podchodzisz do męzczyzn na środku lokalu.\n" +
                    ...
                    wybor1=scanner.nextInt();
                    if (wybor1==1){
                       print.PrintTxt("Gdy tylko usłyszeli twoje pytanie cała ich rozmowa chichnie\n" +
                        ...
                        print.PrintTxt("Zacząłeś obserwować mężczyzn. Ich zachowanie nie jest na wysokim poziomie,\n" +
                                ...
                                "Męźczyzna wstał od stołu i teraz musisz się z nim zmierzyć",225);
                        Thread.sleep(5000);
                        walka(gracz,oko);
                    }
                    else if (wybor1==3){
                        print.PrintTxt("Próbujesz nieśmiało zagadać do męźczyzn.\n" +
                                ...
                                "zamachuje się mieczem, lecz w ciebie nie trafia.",225);
                        Thread.sleep(5000);
                        walka(gracz,oko);
                    } else if (wybor1==4) {
                        print.PrintTxt("Gdy odwróciłeś się aby odejść od stolika czujesz jak ktoś lapie cię za nadgarstek",225);
                        Thread.sleep(500);
                        print.PrintTxt("Po chwili słyszysz głos z jednego męźczyzn\n" +
                                ...
                                "Twoje maksymalne obrażenia zminiejszyły się o 10%",225);
                        gracz.HP=gracz.HP-5;
                        gracz.player_effects-=0.1;
                        Thread.sleep(750);
                        print.PrintTxt("Po odwróceniu się zauważasz że tym który cię zaatakował był męźczyzna z blizną na oku\n" +
                                "Męźczyzna z blizną na oku:\n Co ty taki oburzony? Dopiero zaczynamy sie bawić\n" +
                                "Po powiedzeniu tego dobywa swojego miecza",225);
                        walka(gracz,oko);
                    }else {
                        System.out.println("Nie ma takiej opcji. Wybierz poprawną opcje.");
                        wybor1=scanner.nextInt();
                    }
                    print.PrintTxt("Po pokonaniu mężczyzny z blizną na oku zauważasz że drugi męźczyzna ma na twarzy\n" +
                            "coś pomiędzy smutkiem a gniewem.",225);
                    Thread.sleep(1000);
                    print.PrintTxt("Po chwili ciszy męźczyzna z dwoma bliznami odzyskał język w gębie\n" +
                            "Mężczyzna z dwiema bliznami:\n NIE MYŚL ŻE UJDZIE CI TO NA SUCHO!!!!\n\n" +
                            "Po powiedzeniu tego on również dobywa swojego miecza",225);
                    walka(gracz,policzki);
                    Thread.sleep(1500);
                    print.PrintTxt("Po tym jak mężczyzna z dwoma bliznami upadł na ziemię podchodzi do ciebie\n" +
                            "mężczyzna w płasczu.\n" +
                    ...
                    gracz.Mana=50;
                    Thread.sleep(2500);
                    print.PrintTxt("Męźczyzna w płaszczu:\n Oraz weź jeszcze to. Przydzą ci się w trakcie twojej podróży\n\n" +
                            "Daje ci 1 złotą monetę i 5 srebrnych\n",225);
                    gracz.srebro+=5;
                    gracz.zloto+=1;
                    print.PrintTxt("Następnie wychodzi z knajpy bez mówienia już niczego",225);
                    CzyBylWKarczmie=true;
                    System.out.println("Postanawiasz też wyjść z karczmy");
                    break;
                }
                else if (wyborkarczma==3){
                    print.PrintTxt("Podchodzisz do mężczyzny. Po podejściu do niego zauważasz że nie przerwanie\n" +
                    ...
                    while (1 == 1) {
                        ...
                        if (ilePytan==3){
                            print.PrintTxt("Meżczyzna macha ci ręką abyś odszedł i mu nie przeszkadzał.\n" +
                                    "Chcąc uniknąc problemów odchodzisz\n",225);
                            break;
                        }else{
                            print.PrintTxt("Mężczyzna nie reaguje na twoje pytanie i kontunuuje sączenie\n" +
                                    "swjego trunku bez tracenie z oczu 2 łysych mężczyzn",225);
                            ilePytan+=1;
                        }if (wybor1==1 || wybor1==2|| wybor1==3){
                ...
                else if (wyborkarczma==4) {
                    System.out.println("Wychodzisz z karczmy");
                    break;

                }
                if (wyborkarczma==1||wyborkarczma==2||wyborkarczma==3){
                    System.out.println("Wracasz pod drzwi karczmy.\n" +
                ...
                if (wyborkarczma!=1&&wyborkarczma!=2&&wyborkarczma!=3&&wyborkarczma!=4){
                    System.out.println("Nie ma takiej opcji. Proszę wybrać poprawną opcję");
                    wyborkarczma=scanner.nextInt();
                }
                    }
    }else {
            print.PrintTxt("Knajpa jest w opłakanym stanie. Na środku leży wyrówcony stół oraz kawałki potłuczonych butelek.\n" +
            ...
            wybor1= scanner.nextInt();
            if (wybor1==1){
                print.PrintTxt("Podchodzisz do barmana ostrożnie omijając kawałki szkła na podłodze.\n" +
                ...
                if (wybor2==1){
                    ...
                    print.PrintTxt("Idziesz dalej do barmana.\n" +
                            ...
                            "** możesz od teraz używać sztyletu w przyszłych starciach**",225);
                    gracz.sztylet=true;
            }else {
                        print.PrintTxt("Idziesz dalej do barmana\n" +
                                "Barman:\n Uciekaj stąd. W każdej chwili mogą zjawić się ich koledzy",225);
                    }
            }
            print.PrintTxt("W obawie o własne bezpieczeństow wychodzisz z karczmy.",225);
        }}


    public void StoiskoWrożki(Player gracz)throws InterruptedException{
        print.PrintTxt("Podchodzisz do stoiska wróżki.\n" +
        ...
        while (1==1){
            ...
            if (wybor == 4) {
                print.PrintTxt("Gdy miałeś odchodzić od straganu słyszysz znowu głos\n" +
                        "staruszki.\n" +
                        ...
                        "Czujesz jak twoje siły życiowe powracają",225);
                gracz.HP=100;
                gracz.Mana=50;
                print.PrintTxt("Dziękujesz staruszcze i odchodzisz od jej straganu",225);
                Thread.sleep(3000);
                break;
            }
        }
    ...
    private void SuroweRyby()throws InterruptedException{
       ...
       print.PrintTxt("Po podejściu do straganu zaczynasz przeglądać rodzaje ryb. Zauważasz że na straganie znajdują się między innymi\n" +
                " dorsze, rekiny, karpie, karasie, krewetki, małże.\n" +
                "Twoje przeglądanie przerywa ci sprzedawca",225);
        Thread.sleep(4000);
        print.PrintTxt("Sprzedawca:\n W czym mogę służyć podróżniku?\n" +
                "Co odpowiesz\n 1- opowiedz mi o tych rybach   \n 2- chciałbym kupić którąś z ryb \n3- tylko przeglądam nie mam zamiaru nic kupować",225);
        wybor1=scanner.nextInt();
        ...
        while (1==1){
            ...
            if (wybor1==1){
                print.PrintTxt("Sprzedawca:\nWszystkie nasze ryby są łowione u wybrzeży naszego morza.\n " +
                        ...
                        "Dziękujesz za odpowiedź po czym sprzedawca odchodzi",225);
            }
            ...
            if (wybor1==1 || wybor1==2|| wybor1==3){
                ...
                wybor1= scanner.nextInt();
                if (wybor1==3){
                    print.PrintTxt("Odchodzisz od straganu i znajdujesz się ponownie na środku deptaka",225);
                    break;
                }
            }
    ...
    private void DaniaZRyb() throws InterruptedException {
        print.PrintTxt("Po podejściu do straganu z rybami zaczynasz przeglądać ich menu.\n",225);
        System.out.println("|------------------|\n" +
                "|  Menu            |\n" +
                "|Dorsz w           |\n" +
                "|sosie własnymm    |\n" +
        ...
        while (1==1){
            if (wybor==1){
                ...
                wybor2=scanner.nextInt();
                if (wybor2==1){
                    print.PrintTxt("Próbujesz oszukać kucharza i wmówić mu że zapłacisz później",225);
                    ...
                    int szansa =los(5);
                    if(szansa==0){
                        print.PrintTxt("Udało ci się oszukać kucharza.\n Kucharz:\n Przygotujemy twój posiłek, proszę zająć miejsce w środku ",225);
                        Thread.sleep(1500);
                        print.PrintTxt("Po 15 minutach otrzymujesz swój posiłek. Jest dokładnie taki jak go sobie wyobrażałeś,\n a smakuje jeszcze lepiej.\n" +
                                "Po zjedzeniu opuszczasz lokal aby uniknąć kłopotów",225);
                        break;
                    }else{
                        print.PrintTxt("Nie udało ci się.\n Kucharz:\n Prosze opuścić lokal i mi się wiecej tu nie pokazywać!!!\n Jesteś zmuszony opuścić lokal",225);
                        break;
                    }
                }else{
                    print.PrintTxt("Przyznajesz się do braku pieniędzy przed kucharzem\n Kucharz:\n" +
                            "Cieszę się że się przyznałeś i nie próbowałeś mnie okraść.\n Niestety nie mogę cię nakarmić za darmo.\n" +
                            "Mogę co najwyżej dać ci próbkę jednego z naszych posiłków.",225);
                }
            }
            else if (wybor==2){
                print.PrintTxt("Kucharz:\n Już proszę.\n Po powiedzeniu tego kucharz udaje się na tył lokalu",225);
                Thread.sleep(750);
                print.PrintTxt("Po chwili czekania kucharz wraca z tależem, \n na którym znajduje się kawałek ryby polany jakimś białym sosem\n " +
                        "Kucharz: Oto próbka naszego najlepszego dania Dorsza w Sosie własnym\n" +
                        "Postanawiasz spróbować\n",225);
                Thread.sleep(1000);
                print.PrintTxt("Ryba była dobrze wysmażona, lecz sos był podejrzanie lepki oraz trochę gorzki.\n" +
                        "Mimo to dziękujesz kucharzowi",225);
            }
            else if (wybor==3){
                print.PrintTxt("Kucharz:\n Jeżeli czegoś będzie potrzeba to proszę mnie zawołać. Będę tuż obok.\n" +
                        " Po powiedzeniu tego odchodzi i zaczyna obsługiwać innego klienta",225);
            }else {
                System.out.println("Nie ma takiej opcji. Proszę wybrać poprawną opcję");
                wybor=scanner.nextInt();
            }
            ...
            wybor=scanner.nextInt();
            if (wybor==3){
                print.PrintTxt("Odchodzisz od straganu i wracasz na środek deptaka",225);
                break;
            }
    ...
    private void WytrworyZOsci()throws InterruptedException{
        print.PrintTxt("Po podejściu do straganu zaczynasz przeglądać jego asortyment. Na blacie pod białym materiałowym dachem leżą\n" +
                ...
                "3 - na razie tylko przeglądam",175);
        wybor=scanner.nextInt();
        while (1==1){
            if (wybor==1){
                print.PrintTxt("Sprzedawca:\n Którą konkretnie\n" +
                ...
                wybor2=scanner.nextInt();
                if (wybor2==1){
                    print.PrintTxt("Pytasz się sprzedawcy czy możesz kupić teraz i zapłacić później",225);
                    for (int i =0;i<10;i++){
                        Thread.sleep(250);
                        System.out.print(". ");
                        Thread.sleep(250);
                    ...
                    print.PrintTxt("\n Po chwili namysłu sprzedawca daje ci odpowiedź na twoje pytanie\n" +
                            ...
                            " Sprzedawca odchodzi w głąb straganu",225);
                }else{
                    print.PrintTxt("Mówisz sprzedawcy, że niestety nie posiadasz żadnych pieniędzy\n \n " +
                            ...
                            "Po powiedzeniu tego sprzedawca odchodzi w głąb straganu",225);
                }
            } else if (wybor==2) {
                print.PrintTxt("Sprzedawca:\n Więc mój drogi przyjacielu.\n" +
                        ...
                        "jeszcze na sprzedaż.\n \n  Po powiedzeniu tego odchodzi w głąb straganu",225);


            } else if (wybor==3) {
                print.PrintTxt("Sprzedawca:\n" +
                        "Okej. Jeżeli czegoś będziesz potrzebował to mnie zawołaj. Będę na tyle\n" +
                        "Po powiedzeniu tego odchodzi na tył straganu",225);
            ...
            wybor=scanner.nextInt();
            if (wybor==3){
                print.PrintTxt("Odchodzisz od straganu i wracasz z powrotem na środek deptaka",225);
                break;
            }
        }
    }
        ...
        while (1==1){
            ...
            while (1==1){
                if (EnemyAction==1){
                    ...
                    gracz.DemageTaken(lotr.firstattack(), lotr.name);
                    break;
                }
                else if (EnemyAction==2){
                    System.out.println(lotr.getName() + " uderza cię pięścią");
                    gracz.DemageTaken(lotr.SecondAttack(),lotr.name);
                    break;
